    ...
    public static void main(String[] args) {
        try {
            ...
            PulsarClient client = PulsarClient.builder()
                    ...
                    .serviceUrl("pulsar://localhost:6651").connectionsPerBroker(10).ioThreads(10).listenerThreads(100)
                    .build();
            ...
            Consumer<byte[]> consumer = client.newConsumer().topic(topic)
                    ...
                    .subscriptionName("subscription113").enableBatchIndexAcknowledgment(true)
