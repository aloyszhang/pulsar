...
import org.apache.pulsar.discovery.service.cache.ConfigurationCacheService;
import org.apache.pulsar.discovery.service.cache.ConfigurationMetadataCacheService;
...
public class DiscoveryService implements Closeable {
    ...
    public MetadataStoreExtended createLocalMetadataStore() throws MetadataStoreException {
        return PulsarResources.createLocalMetadataStore(config.getZookeeperServers(),
                config.getZookeeperSessionTimeoutMs(), false);
    }
