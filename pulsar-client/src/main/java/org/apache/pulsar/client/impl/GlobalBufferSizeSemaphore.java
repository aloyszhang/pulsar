...
/**
 * GlobalBufferSizeSemaphore
 *
 */
public class GlobalBufferSizeSemaphore {

    public static final int KB = 1024;

    private static volatile GlobalBufferSizeSemaphore instance;
     ...
     * @param leftSize
     */
    private GlobalBufferSizeSemaphore(int maxSize, int leftSize) {
     ...
     * getInstance
     */
    public static void init(int globalSizeKb) {
        instance = new GlobalBufferSizeSemaphore(globalSizeKb, KB);
    }

    /**
     * getInstance
     */
    public static GlobalBufferSizeSemaphore getInstance() {
        return instance;
    }
